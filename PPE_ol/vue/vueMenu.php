		...
		<ul class="menu">
			...
			}else if(isset($_SESSION['idAdmin']))
			{
				echo '
					<li>GESTION
						<ul class="submenu">
							<li><a href="index.php?page=16" class="listemenu">MESSAGES</a></li>
							<li><a href="index.php?page=17" class="listemenu">INTEGRATION PRODUITS</a></li>
							<li><a href="index.php?page=18" class="listemenu">GESTION NEWSLETTER</a></li>
							<li><a href="index.php?page=23" class="listemenu">NB PRODUITS</a></li>
