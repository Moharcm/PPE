...
<?php
	/******************************************************************************************************/
		...
		$unControleur = new Controleur ("localhost", "siteol", "root","");
		$unControleur_admin = new Controleur_admin("localhost", "siteol", "root","");
		$unControleur_membre = new Controleur_membre("localhost", "siteol", "root","");
		$unControleur_boutique = new Controleur_boutique("localhost", "siteol", "root","");
		$unControleur_message = new Controleur_message("localhost", "siteol", "root","");
